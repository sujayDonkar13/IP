...
# Step 3: Define your KPI for direct travelers and evaluate. Demand Weighted 

println("\n--- Step 3: Direct Travelers Share (DTS) ---")

# Step 4: Define your KPI for fairness and evaluate
# KPI - Fairness Evaluation
println("\n--- Step 4: Fairness KPI ---")

# Optional: Compute Gini Index for fairness




# Step 5: Visualizing lineplans current given line plans 
